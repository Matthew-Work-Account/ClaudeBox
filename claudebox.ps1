...
.DESCRIPTION
    ...
    CLI interface (init/stop/destroy/ref/prune/uninstall/help/config/empty=resume).
    Supports init flags: --rebuild, --no-start.

.PARAMETER Subcommand
    The command to run (init, stop, destroy, ref, prune, uninstall, config, help, or empty for resume).
#>
